...
2. **Configure Repository**
   ...
   - **Nginx configuration** will be automatically built into a custom image
...
The Nginx configuration is stored in `nginx/default.conf` and is automatically built into a custom Nginx image. You can customize it before deployment:
